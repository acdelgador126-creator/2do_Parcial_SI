...
class PagoController extends Controller
{
     ...
     * 
     * @param \App\Models\RegistroPostulantes\Postulante|int|string $postulante
    ...
    public function crearSesion($postulante): JsonResponse
    {
        ...
        $gestionCodigo = $postulante->gestion?->codigo ?? \App\Models\AdmisionCarreras\AdmisionCarreras\Gestion::activa()->first()?->codigo ?? '2026';
    ...
    private function procesarPagoExitoso($session): void
    {
        ...
        if ($postulanteId) {
            ...
            if ($postulante) {
                ...
                $user = \App\Models\Autenticacion\User::where('email', $postulante->email)->first();
                if (!$user) {
                    ...
                    $newUser = \App\Models\Autenticacion\User::create([
